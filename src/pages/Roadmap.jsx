      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs font-bold tracking-[0.18em] text-emerald-600">ROADMAP PÚBLICO</p>
          </div>
        </div>
        <nav className="hidden items-center gap-7 text-sm font-bold text-slate-600 md:flex">
          ...
          <a href="#ideas" className="hover:text-emerald-600">Ideas</a>
          <a href="#proponer" className="hover:text-emerald-600">Proponer</a>
        </nav>
        <a href="#proponer" className="rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-black text-white shadow-lg shadow-emerald-500/25 hover:bg-emerald-600">
          Proponer idea
        </a>
      </div>
    </header>
